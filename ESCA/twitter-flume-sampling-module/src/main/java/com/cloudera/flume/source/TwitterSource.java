...
public class TwitterSource extends AbstractSource
  ...
  public void configure(Context context) {
    ...
    String languageString = context.getString(TwitterSourceConstants.LANGUAGE);
...
//	java.lang.String[] LNs = new java.lang.String[1];
//	LNs[0] = "en";
//	String [] KWs = {"nike"};
//	FilterQuery query = new FilterQuery(0, null, KWs, null, LNs);
	//String [] languages = {"en"};

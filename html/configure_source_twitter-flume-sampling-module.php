		...
		<div class="container container-fullpage">
			<div class="jumbotron container-trasparent text-center">
				<div class="container">
					...
					<h2>twitter-flume-sampling-module</h2>
					<p>
<?php
	...
	$status = $config->getParam("configured_source_twitter-flume-sampling-module");
	...
	else
	{
		...
		else
		{
			...
			{
				$flume_conf = fopen('twitter-flume-sampling-module/flume.conf', 'a');
				...
				fwrite($flume_conf, "\nTwitterAgent.sources.Twitter.isTesting=true");
				...
				echo "<pre>";
				echo shell_exec("cd twitter-flume-sampling-module 2>&1; ./addCron.sh 2>&1");
				echo "</pre>";
				$config->updateParam("configured_source_twitter-flume-sampling-module", "true");
			}
		}
	}
?>
